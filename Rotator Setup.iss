...
; Generated by Othmar Ehrhardt on 03.11.2020 (UTC)
;
[Setup]
AppID={{{EB287798-1DC7-464B-9732-8A76951996DA}}
AppName=ASCOM Stroblhofwarte RotatorDriver
...
OutputDir="."
OutputBaseFilename="Stroblhofwarte.Rotator Setup"
Compression=lzma
...
[Files]
Source: "C:\_develop\ASCOM.Stroblhofwarte.Rotator\ASCOM.Stroblhofwarte.Rotator\ASCOM.Stroblhofwarte.Rotator\bin\ASCOM.Stroblhofwarte.Rotator.dll"; DestDir: "{app}"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Stroblhofwarte.Rotator.dll""";


; Only if driver is .NET
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Stroblhofwarte.Rotator.dll""";
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Stroblhofwarte.Rotator.dll""";
